...
func _run():
	if(state == ""):
		...
		addCharacter("humoi")
		playAnimation(StageScene.Duo, "sit", {npc="humoi"})
		...
		addDisabledButton("Punish","Sorry, not implemented yet. For now you can only accept this unfair deal. But I'm sure this self-rightous dragon will be get punished the future.(maybe not next big update)")
